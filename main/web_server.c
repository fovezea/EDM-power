...
"            \n"
"            <div class=\"status-card\">\n"
"                <h3>Gap Voltage Chart</h3>\n"
"                <canvas id=\"voltage-chart\" width=\"350\" height=\"150\" style=\"border: 1px solid #ccc; background: white; width: 100%; max-width: 350px;\"></canvas>\n"
"            </div>\n"
"            \n"
"            <div class=\"status-card\">\n"
...
"            <div class=\"status-card\">\n"
"                <h3>Motor Control</h3>\n"
"                <div>Cut Speed: <span id=\"cut-speed\" class=\"value-display\">0.10 mm/s</span></div>\n"
"                <input type=\"range\" min=\"0.01\" max=\"1.00\" step=\"0.01\" value=\"0.10\" class=\"slider\" id=\"cut-speed-slider\">\n"
"                <button class=\"button\" onclick=\"setCutSpeed()\">Set Cut Speed</button>\n"
"                <div style=\"margin-top: 10px;\">Jog Speed: <span id=\"jog-speed\" class=\"value-display\">1.0 mm/s</span></div>\n"
...
"            \n"
"            // Only update cut speed display if slider is not being actively used and user hasn't set a value\n"
"            if (!sliderActive.cutSpeed && lastUserValues.cutSpeed === null) {\n"
"                document.getElementById('cut-speed').textContent = data.cut_speed.toFixed(2) + ' mm/s';\n"
"                document.getElementById('cut-speed-slider').value = data.cut_speed;\n"
"            } else if (lastUserValues.cutSpeed !== null) {\n"
"                // User has set a value, keep it\n"
"                document.getElementById('cut-speed').textContent = lastUserValues.cutSpeed.toFixed(2) + ' mm/s';\n"
"                document.getElementById('cut-speed-slider').value = lastUserValues.cutSpeed;\n"
"            }\n"
"            \n"
...
"        }\n"
"\n"
"        function setCutSpeed() {\n"
"            var speed = document.getElementById('cut-speed-slider').value;\n"
"            sendCommand('set_cut_speed', parseFloat(speed));\n"
"            lastUserValues.cutSpeed = null; // Allow polling to take over\n"
"        }\n"
"\n"
"        function setPID() {\n"
...
"            var minVal = Math.min(...chartData);\n"
"            var maxVal = Math.max(...chartData);\n"
...
"                var x = (i / (chartData.length - 1)) * width;\n"
"                var y = height - ((chartData[i] - minVal) / range) * height;\n"
"                \n"
"                if (i === 0) {\n"
"                    chartCtx.moveTo(x, y);\n"
"                } else {\n"
...
"            \n"
"            // Y-axis labels\n"
"            chartCtx.fillText(maxVal.toFixed(1) + ' mV', 5, 15);\n"
"            chartCtx.fillText(minVal.toFixed(1) + ' mV', 5, height - 5);\n"
"            \n"
"            // X-axis label\n"
"            chartCtx.fillText('Time (60s)', width - 80, height - 5);\n"
"        }\n"
"\n"
...
"        \n"
"        // Cut Speed slider\n"
"        var cutSpeedSlider = document.getElementById('cut-speed-slider');\n"
"        cutSpeedSlider.addEventListener('mousedown', function() { sliderActive.cutSpeed = true; });\n"
"        cutSpeedSlider.addEventListener('mouseup', function() { \n"
"            sliderActive.cutSpeed = false; \n"
"            lastUserValues.cutSpeed = parseFloat(this.value);\n"
"        });\n"
"        cutSpeedSlider.addEventListener('input', function() {\n"
"            document.getElementById('cut-speed').textContent = parseFloat(this.value).toFixed(2) + ' mm/s';\n"
"        });\n"
"    </script>\n"
"</body>\n"
"</html>";
